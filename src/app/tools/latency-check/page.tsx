...
import { Search, Activity, Zap, Server, Play, Square, ArrowLeft } from "lucide-react";
    ...
    const checkLatency = async (url: string) => {
        try {
            ...
            if (!data.error) {
                ...
                setHistory(prev => [...prev.slice(-19), newData]); // Keep last 20 points
            }
        } catch (error) {
            console.error("Latency check error:", error);
            setIsMonitoring(false); // Stop on hard check error
        }
    };
    ...
    return (
        <div className="min-h-screen p-6 md:p-12">
            <div className="max-w-6xl mx-auto">
                ...
                <Card className="mb-6">
                    <form onSubmit={handleToggle} className="flex gap-4">
